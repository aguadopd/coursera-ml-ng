...
- Es equivalente hablar de una *unidad*, una *neurona*, la salida de una neurona o la *activación* de una neurona. Siempre hablamos del resultado de la función de activación ante ciertas entradas y parámetros o pesos: $h(\theta,x)$. La neurona en sí no tiene significado en el modelo, aunque lo tiene en el diagrama.
