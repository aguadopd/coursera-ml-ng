...
#+html_link_up:
#+html_mathjax:
#+html_head: <style type="text/css">body{ max-width:55rem; margin:auto; line-height:1.5}</style>
#+html_head_extra:
#+subtitle:
#+infojs_opt:
...
* Semana 2: Linear regression with multiple variables
...
/En [[*Normal equation]] se introduce notación matricial que luego en el ejercicio 1 usamos para expresar todo de forma vectorizada. Dejo todo acá para más completitud/.
...
más grandes. Sin embargo en [[*Gradient descent in practice I - Feature scaling]] dice:
...
¡Lo que dice en [[*Gradient descent in practice I - Feature scaling]] está mal expresado entonces!
...
* Semana 3: Logistic regression & Regularization
...
* Semana 4: Neural networks: representation
...
* Semana 6: Advice for applying Machine Learning
...
* Semana 7: Support Vector Machines
