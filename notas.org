...
El algoritmo más usado para reducción dimensional es el llamado "Análsisis de componentes principales" (/Principal Component Analysis, PCA/). Para el (hiper)espacio de representación de nuestros descriptores, /PCA/ busca determinar el hiperplano que minimice las distancias entre los puntos en el hiperespacio y sus proyecciones en el hiperplano.
